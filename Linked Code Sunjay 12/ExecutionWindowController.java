...
//    }
    ...
    public void backToInputNumber(ActionEvent event) throws IOException {
        ...
        Parent inputNumberScene = FXMLLoader.load(getClass().getResource("sample.fxml"));
     ...
     */
    public void initData(Controller.SORT nameOfAlgo, TextField numSorted, Controller.SORT sort, Controller.TYPE type) throws IOException {
        ...
        numberSorted.setText(numSorted.getText());
        if(nameOfAlgo == Controller.SORT.BUBBLE)
        {
            nameOfAlgorithmn.setText("Bubble Sort");
        }
        if(nameOfAlgo == Controller.SORT.INSERTION)
        {
            nameOfAlgorithmn.setText("Insertion Sort");
        }
        if(nameOfAlgo == Controller.SORT.SELECTION)
        {
            nameOfAlgorithmn.setText("Selection Sort");
        }
        //this.sort=sort;
        //this.type=type;
        if(sort == Controller.SORT.SELECTION)
        {
            nameOfAlgorithmn.setText("Selection Sort");
            if(type == Controller.TYPE.DOUBLE)
            {
                ...
                pickStoreDouble = RetrieveDoubleFromFile(numSorted.getText().toString(), doubleData);
            ...
            if(type == Controller.TYPE.INT)
            {
                ...
                // Populates the HashTable with the random values
                pickStoreDouble = RetrieveIntFromFile(numSorted.getText().toString(), intData);
                // Sets the textBox of unsorted array values to all values in the textbox
            ...
            if(type == Controller.TYPE.FLOAT)
            {
                ...
                // Populates the HashTable with the random values
                pickStoreDouble = RetrieveFloatFromFile(numSorted.getText().toString(), floatData);
                // Sets the textBox of unsorted array values to all values in the textbox
        ...
        if(sort == Controller.SORT.INSERTION)
        {
            nameOfAlgorithmn.setText("Insertion Sort");
            if(type == Controller.TYPE.DOUBLE)
            {
        ...
        if(sort == Controller.SORT.BUBBLE)
        {
            nameOfAlgorithmn.setText("Bubble Sort");
            if(type == Controller.TYPE.DOUBLE)
            {
...
//        float[] floatData = new float[100000];
     ...
     */
    public void loadAnimationWindow(MenuButton menuButton, ActionEvent actionEvent, Controller.ANIMATION animationType, Stage stage) throws IOException {
        ...
        Parent newSceneParetn = FXMLLoader.load(getClass().getResource("ExecutionWindow.fxml"));
        // This line gets the Stage information
//        Scene newScene = new Scene(root);
//        Stage newStage = new Stage();
//        newStage.setScene(newScene);
//        Stage windowAnimation = (Stage) ((Node)actionEvent.getSource()).getScene().getWindow();
        if(animationType == Controller.ANIMATION.INSERTION)
        {
            loadAnimationWindowInsertionSort(stage);
        }
        if(animationType == Controller.ANIMATION.BUBBLE)
        {
            loadAnimationWindowBubbleSort(stage);
        }
        if(animationType == Controller.ANIMATION.SELECTION)
        {
            loadAnimationWindowSelectionSort(stage);
        }
        if(animationType == Controller.ANIMATION.TREE)
        {
            Parent parent = FXMLLoader.load(getClass().getResource("BinaryTree.fxml"));
        ...
        {
            Parent parent = FXMLLoader.load(getClass().getResource("Hashtable.fxml"));
            Scene scene = new Scene(parent);
            Stage window = (Stage) menuButton.getScene().getWindow();
            window.setScene(scene);
            window.show();
    ...
    public void loadAnimationWindowInsertionSort(Stage primaryStage) {
//        //create the variables and data frist, then add it to the children of a group, then add the group to a scene.
//        Text numberSortedTemp = this.numberSorted;
//        // Need to rename to whatever algorithmn we are on
//        Text nameOfAlgorithmnTemp = this.nameOfAlgorithmn;
//        TextArea unsortedArrayElementsTemp = this.unsortedArrayElements;
//        TextArea sortedArrayElementsTemp = this.sortedArrayElements;
//        Text TimeExectionTextBoxTemp = this.TimeExectionTextBox;
//        Button ShowSubSceneTemp = this.ShowSubScene;
//        BorderPane SubSceneBorderPaneTemp = this.SubSceneBorderPane;
//        javafx.scene.SubScene SubSceneTemp = this.SubScene;
...
//final steps
        ...
        backButton.setOnAction(e -> {
            ...
            try {
                newSceneParetn = FXMLLoader.load(getClass().getResource("sample.fxml"));
//                this.numberSorted = numberSortedTemp;
//                this.nameOfAlgorithmn = nameOfAlgorithmnTemp;
//                this.unsortedArrayElements = unsortedArrayElementsTemp;
//                this.sortedArrayElements = sortedArrayElementsTemp;
//                this.TimeExectionTextBox = TimeExectionTextBoxTemp;
//                this.ShowSubScene = ShowSubSceneTemp;
//                this.SubSceneBorderPane = SubSceneBorderPaneTemp;
//
//                Text numberSorted = this.numberSorted;
//                // Need to rename to whatever algorithmn we are on
//                Text nameOfAlgorithmn = this.nameOfAlgorithmn;
//                TextArea unsortedArrayElements = this.unsortedArrayElements;
//                TextArea sortedArrayElements = this.sortedArrayElements;
//                Text TimeExectionTextBox = this.TimeExectionTextBox;
//                Button ShowSubScene = this.ShowSubScene;
//                BorderPane SubSceneBorderPane = this.SubSceneBorderPane;
//                javafx.scene.SubScene SubScene = this.SubScene;
    ...
    public void loadAnimationWindowBubbleSort(Stage primaryStage) {
        //create the variables and data frist, then add it to the children of a group, then add the group to a scene.
...
//        }
    ...
    public static void ObjectMoveBubbleSort(Rectangle rectangle, Double newXPos) {  //
